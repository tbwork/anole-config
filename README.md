...
> If you just want to use Anole-Loader's basic function for retrieving properties without distinguishing the environment, you can skip this step. And the default environment would be 'all'.
